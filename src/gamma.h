 ...
 *
 * @author Marcin Peczarski <marpe@mimuw.edu.pl> i trochę dopisał Rafał Szulc
...
/** @brief Sprawdza ile liczba ma cyfr. Liczba musi być zakresowo uint32_t.
 * @param[in,out] number - liczba do sprawdzenia.
 * @return Liczba cyfr numbera.
 */
uint32_t number_of_digits(uint32_t number);

/** @brief Zwraca ilość graczy w grze.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry.
...
/** @brief Zwraca ilość zajętych pól przez gracza.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry.
 * @param[in] player  – numer gracza.
 * @return Ilość zajętych pól przez gracza.
 */
uint64_t return_fields_taken(gamma_t *g, uint32_t player);

/** @brief Zwraca ilość wolnych pól dla danego gracza.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry.
 * @param[in] player  – numer gracza.
 * @return Ilość wolnych pól dla danego gracza.
 */
